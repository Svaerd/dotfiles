...
Item {
    ...
    property int gridColumns: getSetting("columns", 3)
    property real gridScale: getSetting("scale", 0.16)
    property bool hideEmptyRows: getSetting("hideEmptyRows", true)
    property bool showScratchpadWorkspaces: getSetting("showScratchpadWorkspaces", true)
    ...
    property int previewFixedCornerRadius: getSetting("previewFixedCornerRadius", 15)
    ...
    property real overviewBackgroundOpacityRatio: getSetting("overviewBackgroundOpacityRatio", 0.5)
    ...
    function refresh() {
        ...
        previewFixedCornerRadius = getSetting("previewFixedCornerRadius", 15);
